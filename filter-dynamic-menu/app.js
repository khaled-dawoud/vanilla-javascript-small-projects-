...
const displayMenuButtons = (mineMenu)=>{
  // menu unique categories
  const categories = mineMenu.reduce((values, item)=>{
...
//display menu onload 
const displayMenuItems = (mineMenu) => {
  let displayCards = mineMenu.map((card)=>{
...
sectionCenter.innerHTML = displayCards
}
